        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-header">
                  <center>
                        <h4>Particulars of the All Centres For Batch Uploading</h4>
...
$result ="SELECT * FROM centers where cen_id ='$cen_id' AND cen_status = 'Approved' ";
$result=mysqli_query($con,$result);
    if ($result->num_rows > 0) {
    echo "<div style='overflow:auto;'><table class='table table-bordered mb-0 text-nowrap'><thead><tr class='bg-primary'><th>Centre UID</th><th>Centre Name</th><th>Centre State</th><th>State of Operation</th><th>Generate UBN</th></tr>";
      while($row = mysqli_fetch_array($result))  { 
        echo "<tr><td>".$row["cen_id"]."</td><td>".$row["cen_name"]."</td><td>".$row["cen_state"]."</td><td>".$row["opr_state"]."</td><td><a href='upload-batch-details.php?center_id=".$row["center_id"]."'>Generate</a></td></tr>";
    }
    echo "</div></table>";
} else {
    echo "<center><h4>Your Data has not been approved by SNA. Once Approved You Can Generate ABN!!</h4></center>";
}
mysqli_close($con);
?>
