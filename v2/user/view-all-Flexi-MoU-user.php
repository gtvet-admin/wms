            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <center><h4>Flexi MoU Training Partners</h4></center>
                    </div>
                    <div class="card-body">
                        <?php
include ('scripts/dbcon.php');
$cen_id = $_SESSION['cen_id'];
$result ="SELECT * FROM  cen_list";
$result=mysqli_query($con,$result);
    if ($result->num_rows > 0) {
    echo "<table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>Centre UID</th><th>Training Partner Name</th><th>Status</th><th>View</th><th>Action</th></tr></thead>";
      while($row = mysqli_fetch_array($result))  { 
        echo "<tr><td>".$row["cen_code"]."</td><td>".$row["cen_name"]."</td><td>".$row["status"]."</td><td><a href='view-".$scheme."-user-role.php?cen_code=".$row["cen_code"]."'>View</a></td><td><a href='add-".$scheme."-user-role.php?cen_code=".$row["cen_code"]."'>Add</a></td></tr>";
		}
    echo "</div></table>";
} else {
