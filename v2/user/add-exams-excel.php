            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <center><h4>Download Sample Templates</h4></center>
                         
                    <div class="card-body">
                         <div style='overflow:auto;'>
                         <table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>First Year</th><th>Second Year</th></tr></thead>
						 <tr><td><a href="assets/exam_marks-i.csv" class="btn-sm btn-social btn-success m-b-5"><i class="fa fa-file-excel-o"></i>  Download Template</a></td></td><td><a href="assets/exam_marks-iii-iv.csv" class="btn-sm btn-social btn-success m-b-5"><i class="fa fa-file-excel-o"></i> Download Template</a></td></tr>
						 </table>
						 </div>
                    </div>
                    <div class="card-body">
        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <center>
                        <h4>Particulars of the All Candidate Uploaded</h4>
...
$result=mysqli_query($con,$sql);
    ...
    echo "<div style='overflow:auto;'><table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>Center Name</th><th>Total Candidates Uploaded</th><th>Total Candidates Assigned</th><th>Total Candidates Un-assigned</th><th>View Candidates</th></tr></thead>";
      while($row = mysqli_fetch_array($result))  { 
 
        echo "<tr><td>".$org_name."</td><td>".$row["ttl_cnt"]."</td><td>".$row["ttl_btch"]."</td><td>".$row["ttl_unass"]."</td><td><a href='view-batch-excel.php?cen_id=".$row["cen_id"]."'>View</a></td></tr>";
    }
    echo "</div></table>";
} else {
...
include ('scripts/dbcon.php');
$cen_id = $_SESSION['cen_id'];
$sql ="SELECT *, (CASE WHEN status = 'Approved' THEN 'Uploaded' ELSE 'Not Uploaded' END) as status FROM cen_list";
$result=mysqli_query($con,$sql);
    if ($result->num_rows > 0) { 
    echo "<div style='overflow:auto;'><table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>Center Name</th><th>Upload Excel</th></tr></thead>";
      while($row = mysqli_fetch_array($result))  { 
 $abn="";
		  switch ($row['status']) {
			case "Uploaded":
			   $abn=  "<td style='background-color:#4caf50;'><a style='color: #fff;' href='upload-exams-excel-check.php?cen_code=".$row["cen_code"]."'>Upload File</a></td>";
				break;
				
				default:
				    $abn= "<td style='background-color:red;'><a style='color: #fff;'>Centre Not Approved</a></td>";
			}
        echo "<tr><td>".$row["cen_name"]."</td>$abn</tr>";
    }
    echo "</div></table>";
} else {
    echo "<center><h4>Data Not Uploaded! Please contact Admin!</h4></center>";
