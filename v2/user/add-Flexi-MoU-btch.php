            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <center><h4>Flexi MoU - GTVET - Batches</h4></center>
                    </div>
                    <div class="card-body">
                        <?php
...
$result=mysqli_query($con,$result);
    ...
    echo "<table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>Centre UID</th><th>Centre Name</th><th>Location</th><th>Status</th><th>Centre Details</th></tr></thead>";
      while($row = mysqli_fetch_array($result))  {
		...
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href=''>Verify</a></center></td></td></tr>";
			   ...
			   <tr><centre><td>1.Add / View Uploaded Candidate</td>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href='add-batch-excel.php'>Add</a></center></td></td></tr>
		<tr><td>2.Upload Candidate Photos</td></centre>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href='add-batch-photo.php'>Upload</a></center></td></td></tr>
		<tr><td>3.Upload ID Proofs</td></centre>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href='add-batch-id-proofs.php'>Upload</a></center></td></td></tr>
		<tr><td>4.Generate Lernern ID</td></centre>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href='add-trainee-id.php'>Generate</a></center></td></td></tr>";
		case "CM":
		...
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href='add-dropout-photo.php'>Upload</a></center></td></td></tr>";
      } else { //if duration < 45  
            $rle2= "<tr><centre><td>5.Candidate Data Correction</td></centre>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href='add-batch-corr.php'>Edit</a></center></td></td></tr>
		<tr><centre><td>6.Candidate Data Verification</td></centre>
