<?php
    ...
    } elseif($scheme == "Staffing") {        //Get User Information from database        $selectUserQuery = "SELECT * FROM `opt_scheme` WHERE `cen_id` = '$cen_id'";        $selectUserQueryResult = $conn->query($selectUserQuery);    } 
	}
  }
    //get Toast Message
    $message = "";
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <center><h4><?=$sch;?> - GTVET - Student Docs</h4></center>
                    </div>
                    <div class="card-body">
                        <?php
...
$result=mysqli_query($con,$result);
    ...
    echo "<table class='table table-bordered mb-0'><thead><tr class='bg-primary'></thead>";
      while($row = mysqli_fetch_array($result))  {
		switch ($role) {
			case "CM":
			   $rle= "<table class='table table-bordered mb-0'><tr>
			   <tr><centre><td>1.$sch Certificates</td>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href='add-batch-excel.php'>View</a></center></td></td></tr>
		<tr><td>2.Training Enrollment Certificate</td></centre>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href='add-batch-photo.php'>View</a></center></td></td></tr>
		<tr><td>3.Training Reciepts</td></centre>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href='view-rcpts.php?cen_id=$cen_id&scheme=$sch&ind=$ind'>View</a></center></td></td></tr>";
		case "CM":
