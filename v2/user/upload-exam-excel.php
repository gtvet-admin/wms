...
<!-- Display status message -->
   ...
   <section class="section">
	...
	<div class="card">
              ...
              <form class="form-horizontal" action="" method="post"
                name="frmCSVImport" id="frmCSVImport" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" class="form-control" id="text_2" name="cen_id" value="<?php echo $cen_id ?>" >
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Upload Scanned &amp; Signed PDF file :</label>
                                            <div class="col-md-9">
                                                 <input type="file" name="file"
                        id="file" accept=".csv">
        ...
        <input type="submit" id="submit" name="import"
                        class="btn btn-primary btn-block btn-flat" value="Upload PDF"></br></br>
                        <div id="response" class="<?php if(!empty($type)) { echo $type . " display-block"; } ?>"><?php if(!empty($message)) { echo $message; } ?></div></br></br>
    </form>
	...
	<div class="card-header">
        ...
        <tbody>
         <?php
            $sqlSelect = "SELECT * FROM btch_2 WHERE cen_id = '$ubn'";
