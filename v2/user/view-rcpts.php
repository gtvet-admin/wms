...
$ubn = $_REQUEST['cen_id'];
$query = "SELECT * FROM rcpts WHERE cen_id= '$ubn'";
...
<!-- Display status message -->
   ...
   <section class="section">
	...
	<div class="card-header">
                    <center>
                        <h4>View <?=$sch;?> Trainee Reciepts</h4>
                    <br/>
        ...
        <tbody>
         <?php
            $sqlSelect = "SELECT * FROM rcpts WHERE cen_id = '$ubn' AND lern_prog ='$sch' AND lernern_id != '' AND estatus = '1' AND industry ='$ind'";
            ...
            <tr>
				...
				<td><center><a target="_blank" class='btn-sm btn-block btn-success btn-upload' href='scripts/rcpts/training-reciepts.php?mprId=<?php echo $row["lernern_id"];?>'>Download</a></center></td>
