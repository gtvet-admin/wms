            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <center><h4>List of Eligible Trainees For Admit Cards</h4></center>
                    </div>
                    <div class="card-body">
...
$cen_id = $_SESSION['cen_id'];
$sql ="SELECT *, b.cen_name as exm_cen, COUNT(DISTINCT(a.roll_no)) as ttl_cnt FROM exam_elg_trn a INNER JOIN exm_cen_list b ON a.cen_code = b.cen_code where b.cen_id ='$cen_id'";
$result=mysqli_query($con,$sql);
    if ($result->num_rows > 0) {
    echo "<div style='overflow:auto;'><table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>Exam Center Name</th><th>Total Trainee Eligble</th><th>Total Batches</th><th>View Trainee</th></tr></thead>";
      while($row = mysqli_fetch_array($result))  { 
 
        echo "<tr><td>".$row["exm_cen"]."</td><td>".$row["ttl_cnt"]."</td><td></td><td><a href='admt-crds.php?cen_code=".$row["cen_code"]."'>View</a></td></tr>";
    }
    echo "</div></table>";
} else {
