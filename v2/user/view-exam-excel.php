...
<!-- Display status message -->
   ...
   <section class="section">
	...
	<div class="card-header">
                    <center>
                        <h4>Result Data Uploaded For <?=$sem;?> Year</h4>
                    </center>
                </div>
		</br>
			</br>
               <div style='overflow:auto;'><table class="table table-striped table-bordered">
        ...
        <tbody>
         <?php
			$ubn = $_REQUEST['cen_code'];
			$sem = $_REQUEST['sem'];
            $sqlSelect = "SELECT * FROM exam_marks WHERE cen_vtp = '$ubn' AND mrks_sem = '$sem'";
            ...
            <tr>
                ...
                <td><?php echo $row['trng_sess']; ?></td>
				<td><?php echo $row['exam_mnth']; ?></td>
				<td><?php echo $row['trade']; ?></td>
				<td><?php echo $row['mrks_p1']; ?></td>
				<td><?php echo $row['mrks_p2']; ?></td>
				<td><?php echo $row['mrks_p3']; ?></td>
				<td><?php echo $row['mrks_p4']; ?></td>
				<td><?php echo $row['mrks_pr']; ?></td>
				<td><?php echo $row['mrks_ia']; ?></td>
				<td><?php echo $row['mrks_ttl']; ?></td>
