...
<head>
	...
	<meta name="description" content="Flexi MoU September 2022 Admit Cards " />
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"></script>
	<title><?=$abn, $tname;?>-Admit Card</title>
    <script>
        function printpage() {
...
?>
			...
			<td>
			<center>
			<a href='https://wa.me/send?phone=919899789961&text=Dear <?=$tname;?>,%0aYou are eligible for Flexi MoU Exam conducted by CUTM-GTVET with Directorate General of Training(MSDE), Govt of India in the month of September - 2022.%0aYou can directly visit to the URL and download your Admit Card.%0a<?=$actual_link;?>'>Download</a>
			</center>
			</td>
			</tr>
            </table>
