...
<div class="ican-img2">
	<p style='font-family: AddingtonCF-Bold; font-size:18px; text-align: center; line-height: 50%; color:#1792b9; font-weight: 600;' class="name-user"> Department: <?=$dep;?></p>
	</div>
	<!--<div class="ican-img2">
...
<div class="course-name">
	<p style='font-family: AddingtonCF-Regular; font-size:18px; text-align: left; line-height: 50%; font-weight: 600; line-height: 125%;' class="cname">This is to certify that <?=$fname;?> <?=$mname;?> <?=$lname;?> bearing Lernern ID : <?=$mpr;?></br> has  <?=$scheme;?> as per the details given below</br></br><strong></strong></p>
	</div>
