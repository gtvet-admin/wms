...
<head>
    ...
    <title>Amasy : Username & Password</title>
    <style type="text/css">
        #outlook a {padding:0;}
...
<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable" style="margin:0; padding:0; width:100% !important; line-height: 100% !important; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" width="100%">
    <tbody><tr>
        ...
        <td valign="top" align="center">
            <!--[if (gte mso 9)|(IE)]>
            <table width="600" align="center" cellpadding="0" cellspacing="0" border="0" style="background-color: gray; border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                <tr>
                    <td>
            <![endif]-->
            <table cellpadding="0" cellspacing="0" border="0" align="center" style="width: 100%; max-width: 600px; background-color: #FFF; border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;" id="contentTable">
                <tbody><tr>
                    <td width="600" valign="top" align="center" style="border-collapse:collapse;">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" style="background: #F9FAFB; background-color: #b7e371;" width="100%">
                            <tbody><tr>
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #E0E4E8; background-color: #b7e371;" width="100%">
                            <tbody><tr>
                                <td align="center" style="padding: 56px 56px 28px 56px;" valign="top">
                                    <a style="color: #3498DB; text-decoration: none;" href="https://gopik.org" target="_blank"><img style="width: 50%; border: 0;" alt="GoPik" src="https://gopikbazaar.in/uat/app/project-connect/scripts/mail/mail-templates/krushi.png">
                                    </a></td>
                            </tr>
                            <tr>
                                <td align="center" style="padding: 0 56px 28px 56px;" valign="top">
                                    <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 20px; color: #333;"><strong>Here is Your Login Credentials</strong>
                                        <br/>
                                        <br/>
                                        <b>Hi, InsertFPONameHere,</b><br/><br/> Welcome to the world of GoPik Krushi. Please use the below mentioned credentials to login to your account in GoPik Krushi App.
                                        <h4>Username : InsertUserNameHere</h4>
                                        <h4>Access PIN : InsertPassHere</h4>
                                        <h4>Name : InsertKeyHere</h4>
                                        <h4>Designation : InsertRoleHere</h4>
                                        <h4>Date of Registration : InsertDateHere</h4>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" style="padding: 0 56px; padding-bottom: 56px;" valign="top">
                                    <div><!--[if mso]>
                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:40px;v-text-anchor:middle;width:270px;" arcsize="125%" stroke="f" fillcolor="#E15718">
                                            ...
                                            <center>
                                        <![endif]-->
                                        <!--<a href="InsertLinkHere" style="background-color:#E15718;border-radius:50px;color:#ffffff;display:inline-block;font-family: 'lato', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:18px;font-weight: bold;line-height:40px;text-align:center;text-decoration:none;width:270px;-webkit-text-size-adjust:none;" target="_blank">Click Here To Login</a>
                                        <!--[if mso]>
                            ...
                            <tr>
                                <td align="center"  style="padding: 28px 56px; background-color: #b7e371;" valign="top">
                                    <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 16px; color: #666666; font-weight: 900;">Copyright © 2021
                                        <br/>
                                        GoPik Connect Private Limited</div>
                                    <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 10px; color: #000;">Designed &amp; Developed By Anuj Tiwari
                                    </div>
                                </td>
                            </tr>
                            </tbody></table>
