...
<head>
    ...
    <title>DGT : Flexi MoU ITP Username & Password</title>
    <style type="text/css">
        #outlook a {padding:0;}
        ...
        h1 a:active, h2 a:active,  h3 a:active, h4 a:active, h5 a:active, h6 a:active {color: white;}
        h1 a:visited, h2 a:visited,  h3 a:visited, h4 a:visited, h5 a:visited, h6 a:visited {color: white;}

        table td {border-collapse: collapse;}
        table { border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; }

        a {color: #3498db;}
        p.domain a{color: white;}
            ...
            <table cellpadding="0" cellspacing="0" border="0" align="center" style="width: 100%; max-width: 600px; background-color: #FFF; border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;" id="contentTable">
                <tbody><tr>
                    <td width="600" valign="top" align="center" style="border-collapse:collapse;">
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #E0E4E8; background-color: #4195ff" width="100%">
                            <tbody><tr>
                                <td align="center" style="padding: 56px 56px 28px 56px;" valign="top">
                                    <a style="color: #3498DB; text-decoration: none;" href="#" target="_blank"><img style="width: 25%; border: 0;" alt="DGT_Logo" src="https://gtetonline.com/flexi-mou/dgt/assets/img/dgt-logo.png"><img style="width: 25%; border: 0;" alt="Skill_India" src="https://gtetonline.com/flexi-mou/dgt/assets/img/skill_india.png">
                                    </a></td>
                            </tr>
                            <tr>
                                <td align="center" style="padding: 0 56px 28px 56px;" valign="top">
                                    <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 20px; color: #fff;"><strong>DGT Flexi-MoU ITP Login Credentials</strong><br/>
                                        <br/>
                                        Hi InsertNameHere, Your ITP Request has been approved. Please use the below mentioned credentials to login to your account.
                                        <h4>Username : InsertUserNameHere</h4>
                                        <h4>Password : InsertPasswordHere</h4>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="center" bgcolor="#F9FAFB" style="padding: 28px 56px;" valign="top">
                                    <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 12px; color: #666666; font-weight: 900;">Copyright © 2022
                                        <br/>
										Directorate General of Training<br/>
