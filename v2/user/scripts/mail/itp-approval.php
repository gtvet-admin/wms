...
<head>
    ...
    <title>DGT : Flexi MoU ITP Approval Request</title>
    <style type="text/css">
        #outlook a {padding:0;}
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #E0E4E8; background-color: #4195ff" width="100%">
                            <tbody><tr>
                                <td align="center" style="padding: 56px 56px 28px 56px;" valign="top">
                                    <a style="color: #3498DB; text-decoration: none;" href="https://http://amasy.cutmams.in/" target="_blank"><img style="width: 40%; border: 0;" alt="Amasy" src="https://gtetonline.com/flexi-mou/dgt/assets/img/dgt-logo.png"><img style="width: 40%; border: 0;" alt="Amasy" src="https://gtetonline.com/flexi-mou/dgt/assets/img/skill_india.png">
                                    </a></td>
                            </tr>
                            <tr>
                                <td align="center" style="padding: 0 56px 28px 56px;" valign="top">
                                    <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 14px; color: #fff;"><strong>ITP Approval Request</strong>
                                        <br/>
                                        Dear Sir / Mam, <br/>
                                        A New ITP Submitted a new Approval Request. Please find the ITP information below for your approval.</div>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" style="padding: 0 56px; padding-bottom: 56px;" valign="top">
                                    <div><!--[if mso]>
                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:40px;v-text-anchor:middle;width:270px;" arcsize="125%" stroke="f" fillcolor="#E15718">
                                            ...
                                            <center>
                                        <![endif]-->
                                        <p style="font-size: 18px; color: white;"><strong>Industrial Training Partner : InsertNameHere</strong></p>
                                        <!--[if mso]>
