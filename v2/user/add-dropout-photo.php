            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <center><h4>Your List of Dropped out Candidates</h4></center>
                    </div>
                    <div class="card-body">
...
$result=mysqli_query($con,$result);
    ...
    echo "<table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>Centre UID</th><th>Centre Name</th><th>Trade</th><th>Location</th><th>Status</th><th>Action</th></tr></thead>";

      while($row = mysqli_fetch_array($result))  { 

        echo "<tr><td>".$row["cen_id"]."</td><td>".$row["org_name"]."</td><td>".$row["lern_course"]."</td><td>".$row["ro_city"]."</td><td>".$row["status"]."</td><td><a href='upload-dropout-photo.php?center_id=".$row["cen_id"]."&trade=".$row["lern_course"]."'>View</a></tr>
