            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <center><h4>List of Approved Centers UBN + Batch Details</h4></center>
                    </div>
                    <div class="card-body">
        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <center>
                        <h4>Particulars of the All UBN Generated</h4>
...
$result ="SELECT *, (CASE WHEN b.photo = 'no-image.png' THEN 'Photo Not Uploaded' ELSE 'Photo Uploaded' END) as phto FROM btch_1 a INNER JOIN btch_2 b ON a.ubn_no = b.ubn_no where a.cen_id ='$cen_id' GROUP BY a.ubn_no";
					
$result=mysqli_query($con,$result);
    if ($result->num_rows > 0) {
    echo "<div style='overflow:auto;'><table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>GTVET ID</th><th>Center Name</th><th>UBN No</th><th>Action</th></tr></thead>";
      while($row = mysqli_fetch_array($result))  { 
           $phto_btn="";
		  
		  switch ($row['phto']) {
			case "Photo Not Uploaded":
			   $phto_btn=  "<td style='background-color: yellow;'><a href='upload-batch-photo.php?ubn_no=".$row["ubn_no"]."' style='color: black;'>Upload Photo</a></td>";
				break;

			default:
				$phto_btn= "<td style='background-color:#4caf50;'><a style='color: #fff;'>Photo Already Uploaded</a></td>";
		  } 
        echo "<tr><td>".$row["cen_id"]."</td><td>".$row["cen_name"]."</td><td>".$row["ubn_no"]."</td><td style=''><a href='upload-batch-photo.php?ubn_no=".$row["ubn_no"]."'>Assign </a></td></tr>";
    }
    echo "</div></table>";
} else {
