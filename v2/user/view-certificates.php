...
<!-- Display status message -->
   ...
   <section class="section">
	...
	<div class="card-header">
                    <center>
                        <h4>View <?=$sch;?> Candidate Certificates</h4>
                    <br/>
					<h5 style="color:red;">Please note download button will be available only for 24 hrs of confirmation of trainee</h5>
					</center>
        ...
        <tbody>
         <?php
            $sqlSelect = "SELECT * FROM certs WHERE cen_id = '$ubn' AND lern_prog ='$sch' AND lernern_id != '' AND estatus = '1' AND industry ='$ind'";
            ...
            <tr>
				<td><?php echo $i;?></td>
				<td><?php echo $row['cert_no'];?><?php echo $row['id'];?></td>
				<td><?php echo $row['lernern_id']; ?></td>
                <td><?php echo $row['fname']; ?> <?php echo $row['mname']; ?> <?php echo $row['lname']; ?></td>
				<td><?php echo $row['mob_no']; ?></td>
				<td><?php echo $row['etmstmp']; ?></td>
				<td><center><a target="_blank" class='btn-sm btn-block btn-success btn-upload' href='scripts/certs/download-<?php echo $sch; ?>-certificate.php?mprId=<?php echo $row["lernern_id"];?>'>Download</a></center></td>
