            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <center><h4>Flexi MoU Centres</h4></center>
                    </div>
                    <div class="card-body">
                        <?php
include ('scripts/dbcon.php');
$cen_id = $_SESSION['cen_id'];
$result ="SELECT * FROM  onboarding a INNER JOIN centers b ON a.cen_id = b.cen_id where a.cen_id ='$cen_id'";
$result=mysqli_query($con,$result);
    ...
    echo "<div style='overflow:auto;'><table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>Client UID</th><th>Industry Partner Name</th><th>Status</th></tr></thead>";
      while($row = mysqli_fetch_array($result))  { 
		...
		<table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>Centre UID</th><th>Centre Name</th><th>Location</th><th>Status</th><th>Action</th></tr></thead>
		<tr><td>".$row["cen_id"]."</td><td>".$row["org_name"]."</td><td>".$row["ro_distt"].",&nbsp;".$row["ro_city"].",&nbsp;".$row["ro_state"]."</td><td>".$row["status"]."</td><td><a href='insert-center.php?center_id=".$row["center_id"]."'>View</a></td></tr></table>
