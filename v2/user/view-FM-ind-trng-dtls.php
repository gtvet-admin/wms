...
$query = "SELECT * FROM ip_details a INNER JOIN course b ON a.cen_id = b.cen_id WHERE b.cen_id= '$center_id'";
...
<input type="hidden" name="new" value="1" />
									<div class="form-group row">
                                        ...
                                        <label class="col-md-3 col-form-label">Qualifications Needed</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="cen_add" value="<?php echo $row['req_qual']; ?>"readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Required Client Headcount</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="cen_add" value="<?php echo $row['req_headcount']; ?>"readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Sector</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="cen_add" value="<?php echo $row['cou_sec']; ?>"readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Course Name</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="cen_add" value="<?php echo $row['cou_name']; ?>"readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Course Code</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="cen_add" value="<?php echo $row['cou_code']; ?>"readonly>
                                        </div>
                                    </div>
                                </div>
					</ul> 
