        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <center>
                        <h4>View Industry Partner Details</h4>
                    </center>
                </div>
                <div class="card-body">
...
$query = "SELECT * FROM onboarding WHERE cen_id= '$center_id'";
...
<input type="hidden" name="new" value="1" />
									<div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="cen_add" value="<?php echo $row['role']; ?>"readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Scheme</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="cen_add" value="<?php echo $row['scheme']; ?>"readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Industry Partner Name</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="cen_add" value="<?php echo $row['org_name']; ?>"readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Date of Onboarding</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="cen_add" value="<?php echo $row['doi']; ?>"readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">State</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="cen_add" value="<?php echo $row['ro_state']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">City</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="cen_distt" value="<?php echo $row['ro_city']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">District</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="cen_city" value="<?php echo $row['ro_distt']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Location</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="cen_state" value="<?php echo $row['ro_city']; ?>">
                                        </div>
                                    </div>
                                </div>
					</ul> 
