                            ...
                            <div class="col-lg-12">
                                   <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" pattern="[0-9]{10}" minlength="10" maxlength="10" name="gmobile" value="<?php echo $row['gmobile']; ?>" readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Annual Income</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" pattern="[0-9]" minlength="3" maxlength="6" name="ann_incme" value="<?php echo $row['ann_incme']; ?>" readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Qualification</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="qual" value="<?php echo $row['qual']; ?>" readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Passing year</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="passing_year" pattern="[0-9]" minlength="4" maxlength="4" value="<?php echo $row['passing_year']; ?>" readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
