...
if(isset($_POST) && !empty($_FILES['image']['name'])){
   ...
   $filepath = 'scripts/uploads/candidateBankProof/'; 
   ...
   { 
      ...
      if(move_uploaded_file($tmp,$filepath)){
		 ...
		 $sql="UPDATE `btch_2` SET bank_proof_url ='$filepath' WHERE mprId = '$mprId'";
		  //var_dump($_POST);
		  //exit;
        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <center>
                        <h4>Upload Photo For Bank Proof</h4>
                    </center>
                </div>
                <div class="card-body">
...
$result ="SELECT *,(CASE WHEN bank_proof_url = 'pdf.png' THEN 'Photo Not Uploaded' ELSE 'Photo Uploaded' END) as phto FROM btch_2 b WHERE mprId ='$prabn'";
$result=mysqli_query($con,$result);
    ...
    echo "<div style='overflow:auto;'><table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>Sl No.</th><th>Candidate ID</th><th>Candidate Name</th><th>Father Name</th><th>Photo</th><th>Upload Photo</th></tr></thead>";
      while($row = mysqli_fetch_array($result))  { 
        ...
        echo "<tr><td>".$row['id']."</td><td>".$row['mprId']."</td><td>".$row["fname"]."&nbsp;".$row["mname"]."&nbsp;".$row["lname"]."</td><td>".$row["fathersName"]."</td><td>"."<img src='".$row['bank_proof_url']."' width='100' height='120'/>"."</td>$phto_btn</tr>";
    }
    echo "</div></table>";
} else {
