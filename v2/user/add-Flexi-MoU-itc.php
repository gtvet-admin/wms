            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <center><h4>Flexi MoU - GTVET - ITC List</h4></center>
                    </div>
                    <div class="card-body">
                        <?php
...
$result=mysqli_query($con,$result);
    ...
    echo "<table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>ITC UID</th><th>ITC Name</th><th>Location</th><th>Status</th><th>Centre Details</th></tr></thead>";
      while($row = mysqli_fetch_array($result))  {
		...
		<center><td>Assign UBN to Candidate</td></center>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href='assign-batch-ubn.php'>Assign</a></center></td></td></tr>
		...
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href=''>Verify</a></center></td></td></tr>";
			   ...
			   <tr><centre><td>1.Add ITC (Industry Training Centre) Details</td>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href='add-itc-details.php?itc_code=$cen_id'>Add</a></center></td></td></tr>
		<tr><td>2.Upload ITC Tri-Party MoU </td></centre>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href=''>Upload</a></center></td></td></tr>";
		case "CM":
		if(($row['edit_status']) == 'No')  {  
          $rle2= "<tr><centre><td>5.Candidate Data Correction</td></centre>
		<td><center><a class='btn-sm btn-block btn-danger btn-danger' href=''>Locked! Contact Admin</a></center></td></td></tr>
		<tr><centre><td>6.Candidate Data Verification</td></centre>
		<td><center><a class='btn-sm btn-block btn-danger btn-danger' href=''>Locked! Contact Admin</a></center></td></td></tr>
		<tr><td>7. Candidate Dropouts Details</td></centre>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href=''>Upload</a></center></td></td></tr>";
      } else { //if duration < 45  
            $rle2= "<tr><centre><td>3.View / Edit ITC Data</td></centre>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href=''>Edit</a></center></td></td></tr>";  
      }//end else 
				break;
        ...
        echo "<tr><td>".$row["cen_id"]."</td><td>".$row["org_name"]."</td><td>".$row["ro_city"]."</td><td>".$row["status"]."</td><td><a href='insert-center.php?cen_id=".$row["cen_id"]."'>View</a></tr></table>
		$rle$rle2
		";
		}
    echo "</div></table>";
