            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <center><h4>List of Eligible Trainees</h4></center>
                    </div>
                    <div class="card-body">
...
$result=mysqli_query($con,$sql);
    ...
    echo "<div style='overflow:auto;'><table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>Exam Center Name</th><th>Total Trainee Eligble</th><th>Total Batches</th><th>View Trainee</th></tr></thead>";
      while($row = mysqli_fetch_array($result))  { 
        ...
        echo "<tr><td>".$row["exm_cen"]."</td><td>".$row["ttl_cnt"]."</td><td></td><td><a href='eligible-trainees.php?cen_code=".$row["cen_code"]."'>View</a></td></tr>";
    }
    echo "</div></table>";
} else {
