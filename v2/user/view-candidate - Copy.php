...
$trainingEndDate = $_POST["trainingEndDate"];
	...
	if($sql)
	{
		?>
        <script>
		alert('Candidate Data was Sucessfully Updated !!!');
...
$query = "SELECT * FROM btch_2 a LEFT JOIN btch_2a b ON a.mprId = b.mprId WHERE a.mprId= '$mprId'";
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab2" data-toggle="tab" href="#institute_details" role="tab" aria-controls="home" aria-selected="true">View Candidate Details</a>
                            </li>
                            
                            <div class="col-lg-12">
                                   <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Candidate ID</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="mprId" value="<?php echo $row['mprId']; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Candidate Name</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="candidateName" value="<?php echo $row['fname']; ?>&nbsp;<?php echo $row['mname']; ?>&nbsp;<?php echo $row['lname']; ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="fathersName" value="<?php echo $row['fathersName']; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Mother Name</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="mothersName" value="<?php echo $row['mothersName']; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" name="gender" value="" readonly>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="mobile" value="<?php echo $row['mobile']; ?>"readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Father Name</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="module" value="<?php echo $row['fathersName']; ?>" readonly>
                                        </div>
                                    </div>
                                   <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Mother Name</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control"  name="mothersName" value="<?php echo $row['mothersName']; ?>" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" pattern="[0-9]" minlength="3" maxlength="6" name="ann_incme" value="<?php echo $row['ann_incme']; ?>">
                                        </div>
                                    </div>
									<div class="form-group row">
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="passing_year" pattern="[0-9]" minlength="4" maxlength="4" value="<?php echo $row['passing_year']; ?>">
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Bank Account Available?</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="bank_acc" value="<?php echo $row['bank_acc']; ?>" readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Bank Name</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="b_name" value="<?php echo $row['b_name']; ?>" readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Account Holder Name</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="acc_name" value="<?php echo $row['acc_name']; ?>" readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Bank Account Number</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="b_acc_no" value="<?php echo $row['b_acc_no']; ?>" readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">Branch Name</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="br_name" value="<?php echo $row['br_name']; ?>" readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-md-3 col-form-label">IFSC Code</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="ifsc" value="<?php echo $row['ifsc']; ?>" readonly>
                                        </div>
                                    </div>
									<div class="form-group row">
                ...
                <div class="submit mt-3 mb-3">
												...
												<div class="submit mt-3 mb-3">
                                                   <a class="btn btn-danger btn-block" href="">Delete Record</a>
												</div>
												<div class="submit mt-3 mb-3">
