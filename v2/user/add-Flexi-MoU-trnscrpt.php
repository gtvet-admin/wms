            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <center><h4>Flexi MoU - GTVET - Student Docs</h4></center>
                    </div>
                    <div class="card-body">
                        <?php
include ('scripts/dbcon.php');
$cen = $_SESSION['cen_id'];
$result ="SELECT * FROM  onboarding where cen_id ='$cen' GROUP BY cen_id";
$result=mysqli_query($con,$result);
    if ($result->num_rows > 0) {
    echo "<table class='table table-bordered mb-0'><thead><tr class='bg-primary'><th>Centre UID</th><th>Centre Name</th><th>Location</th><th>Status</th></tr></thead>";
      while($row = mysqli_fetch_array($result))  { 
        echo "<tr><td>".$row["cen_id"]."</td><td>".$row["org_name"]."</td><td>".$row["org_name"]."</td><td>".$row["status"]."</td></tr></table>
		<table class='table table-bordered mb-0'><tr>
		<center><td>Admit Cards</td></center>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href='view-admit-cards.php?cen_id=".$row["cen_id"]."'>View</a></center></td></tr>
		<tr><td>ID Cards</td></centre>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href=''>Download</a></center></td></tr>
		<tr><td>Sample Job Log Sheet</td></centre>
		<td><center><a class='btn-sm btn-block btn-warning btn-upload' href=''>Download</a></center></td></tr>
		";
		}
    echo "</div></table>";
